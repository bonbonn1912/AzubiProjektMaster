...
public class Kreditlaufzeit : MonoBehaviour
{
   public void LautZeitVeringern()
    ...
    IEnumerator KrediteAbfrage()
    {
       ...
       // WWW www = new WWW("https://dominik.grandpa-kitchen.com/PHP-Skripte/KrediteAbfragenDEV.php", form);
       ...
       //Debug.Log(www.text);
        ...
        for (int i = 0; i<IDs.Length-1; i++)
        {
            ...
            Debug.Log("LID: "+IDs[i]);
          // WWW www1 = new WWW("https://dominik.grandpa-kitchen.com/PHP-Skripte/KreditWertDEV.php", form1);
